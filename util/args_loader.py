...
def get_args():
    ...
    parser.add_argument('--out-datasets', default=['SVHN','LSUN','iSUN','dtd'], type=list, help="['SVHN', 'LSUN', 'LSUN_resize', 'iSUN', 'dtd', 'places365']  ['inat', 'sun50', 'places50', 'dtd', ]")

    parser.add_argument('--name', default="wrn", type=str, help='neural network name and training set')
    parser.add_argument('--model-arch', default='wrn', type=str, help='model architecture [resnet18]')
